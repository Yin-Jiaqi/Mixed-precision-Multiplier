...
entity kernel0_B_IO_L2_in28 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_B_IO_L2_in28 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln870_39_fu_197_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln870_39_reg_243 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal add_ln870_40_fu_213_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln870_40_reg_251 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal icmp_ln1069_40_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal c1_V_reg_90 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln1069_41_fu_207_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_phi_mux_arb_2_phi_fu_142_p4 = ap_const_lv1_1) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_phi_mux_arb_2_phi_fu_142_p4 = ap_const_lv1_0) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_phi_mux_arb_2_phi_fu_142_p4 = ap_const_lv1_1) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_phi_mux_arb_2_phi_fu_142_p4 = ap_const_lv1_0) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln1069_fu_179_p2 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1069_40_fu_191_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1069_40_fu_191_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_1))) then 
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, grp_B_IO_L2_in_intra_trans_fu_150_ap_done, icmp_ln1069_40_fu_191_p2, icmp_ln1069_41_fu_207_p2, icmp_ln1069_fu_179_p2, ap_block_state5_on_subcall_done, ap_CS_fsm_state6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1069_40_fu_191_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln1069_41_fu_207_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
    ...
    add_ln870_39_fu_197_p2 <= std_logic_vector(unsigned(c1_V_reg_90) + unsigned(ap_const_lv3_1));
    add_ln870_40_fu_213_p2 <= std_logic_vector(unsigned(c2_V_reg_114) + unsigned(ap_const_lv6_1));
    ...
    icmp_ln1069_40_fu_191_p2 <= "1" when (c1_V_reg_90 = ap_const_lv3_4) else "0";
    icmp_ln1069_41_fu_207_p2 <= "1" when (c2_V_reg_114 = ap_const_lv6_20) else "0";
