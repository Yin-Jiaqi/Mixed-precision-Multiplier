...
module kernel0_C_drain_IO_L1_out_boundary_wrapper482_Pipeline_VIT (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [4:0] c5_V_fu_44;
wire    ap_loop_init;
reg   [4:0] ap_sig_allocacmp_c5_V_6;
...
assign add_ln870_fu_83_p2 = (ap_sig_allocacmp_c5_V_6 + 5'd1);
...
assign icmp_ln1069_fu_77_p2 = ((ap_sig_allocacmp_c5_V_6 == 5'd16) ? 1'b1 : 1'b0);

assign local_C_V_address0 = zext_ln1069_fu_89_p1;

assign zext_ln1069_fu_89_p1 = ap_sig_allocacmp_c5_V_6;

endmodule //kernel0_C_drain_IO_L1_out_boundary_wrapper482_Pipeline_VIT
