...
wire   [2:0] add_ln870_45_fu_197_p2;
reg   [2:0] add_ln870_45_reg_243;
wire    ap_CS_fsm_state3;
wire   [5:0] add_ln870_46_fu_213_p2;
reg   [5:0] add_ln870_46_reg_251;
...
wire   [0:0] icmp_ln1069_46_fu_191_p2;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_90;
wire   [0:0] icmp_ln1069_47_fu_207_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_4_phi_fu_142_p4 == 1'd1) & (icmp_ln1069_47_fu_207_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_4_phi_fu_142_p4 == 1'd0) & (icmp_ln1069_47_fu_207_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_4_phi_fu_142_p4 == 1'd1) & (icmp_ln1069_47_fu_207_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_4_phi_fu_142_p4 == 1'd0) & (icmp_ln1069_47_fu_207_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln1069_fu_179_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_46_fu_191_p2 == 1'd0))) begin
        arb_4_reg_138 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_fu_64 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_46_fu_191_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1069_fu_179_p2 == 1'd0))) begin
        c1_V_reg_90 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln1069_47_fu_207_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_46_fu_191_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln1069_47_fu_207_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
...
assign add_ln870_45_fu_197_p2 = (c1_V_reg_90 + 3'd1);

assign add_ln870_46_fu_213_p2 = (c2_V_reg_114 + 6'd1);
...
assign icmp_ln1069_46_fu_191_p2 = ((c1_V_reg_90 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln1069_47_fu_207_p2 = ((c2_V_reg_114 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln1069_fu_179_p2 = ((c0_V_fu_64 == 3'd4) ? 1'b1 : 1'b0);

assign start_out = real_start;

endmodule //kernel0_A_IO_L2_in9
