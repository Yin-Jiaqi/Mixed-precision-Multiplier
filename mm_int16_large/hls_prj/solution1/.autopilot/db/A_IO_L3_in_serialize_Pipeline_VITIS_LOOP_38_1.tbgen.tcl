set moduleName A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1
set isTopModule 0
...
set C_modelName {A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_A int 512 regular {axi_master 0}  }
	{ sext_ln38 int 58 regular  }
	{ fifo_A_A_IO_L3_in_serialize1259 int 512 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_A", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_A_A_IO_L3_in_serialize1259", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fifo_A_A_IO_L3_in_serialize1259_din sc_out sc_lv 512 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize1259_full_n sc_in sc_logic 1 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize1259_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_A_A_IO_L3_in_serialize1259_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize1259", "role": "din" }} , 
 	{ "name": "fifo_A_A_IO_L3_in_serialize1259_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize1259", "role": "full_n" }} , 
 	{ "name": "fifo_A_A_IO_L3_in_serialize1259_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize1259", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "fifo_A_A_IO_L3_in_serialize1259", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1 {
		...
		fifo_A_A_IO_L3_in_serialize1259 {Type O LastRead -1 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	...
	fifo_A_A_IO_L3_in_serialize1259 { ap_fifo {  { fifo_A_A_IO_L3_in_serialize1259_din fifo_data 1 512 }  { fifo_A_A_IO_L3_in_serialize1259_full_n fifo_status 0 1 }  { fifo_A_A_IO_L3_in_serialize1259_write fifo_update 1 1 } } }
}
set moduleName A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1
set isTopModule 0
set isCombinational 0
