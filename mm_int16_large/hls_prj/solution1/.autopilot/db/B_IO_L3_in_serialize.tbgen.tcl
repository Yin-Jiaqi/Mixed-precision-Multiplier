...
set C_modelArgList {
	...
	{ B int 64 regular  }
	{ fifo_B_B_IO_L3_in_serialize1260 int 512 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_B", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_B_B_IO_L3_in_serialize1260", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fifo_B_B_IO_L3_in_serialize1260_din sc_out sc_lv 512 signal 2 } 
	{ fifo_B_B_IO_L3_in_serialize1260_full_n sc_in sc_logic 1 signal 2 } 
	{ fifo_B_B_IO_L3_in_serialize1260_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_B_B_IO_L3_in_serialize1260_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "fifo_B_B_IO_L3_in_serialize1260", "role": "din" }} , 
 	{ "name": "fifo_B_B_IO_L3_in_serialize1260_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_B_B_IO_L3_in_serialize1260", "role": "full_n" }} , 
 	{ "name": "fifo_B_B_IO_L3_in_serialize1260_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_B_B_IO_L3_in_serialize1260", "role": "write" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem_B", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1_fu_51", "Port" : "gmem_B", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "B", "Type" : "None", "Direction" : "I"},
			{"Name" : "fifo_B_B_IO_L3_in_serialize1260", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1_fu_51", "Port" : "fifo_B_B_IO_L3_in_serialize1260", "Inst_start_state" : "8", "Inst_end_state" : "9"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1_fu_51", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "fifo_B_B_IO_L3_in_serialize1260", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "fifo_B_B_IO_L3_in_serialize1260_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_373_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1_fu_51.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	B_IO_L3_in_serialize {
		...
		fifo_B_B_IO_L3_in_serialize1260 {Type O LastRead -1 FirstWrite 2}}
	B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_373_1 {
		gmem_B {Type I LastRead 1 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "131083", "Max" : "131083"}
	, {"Name" : "Interval", "Min" : "131083", "Max" : "131083"}
]}
...
set Spec2ImplPortList { 
	...
	fifo_B_B_IO_L3_in_serialize1260 { ap_fifo {  { fifo_B_B_IO_L3_in_serialize1260_din fifo_data 1 512 }  { fifo_B_B_IO_L3_in_serialize1260_full_n fifo_status 0 1 }  { fifo_B_B_IO_L3_in_serialize1260_write fifo_update 1 1 } } }
}
set moduleName B_IO_L3_in_serialize
set isTopModule 0
set isCombinational 0
