...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln373 \
    op interface \
    ports { sext_ln373 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_B_B_IO_L3_in_serialize1260_din { O 512 vector } fifo_B_B_IO_L3_in_serialize1260_full_n { I 1 bit } fifo_B_B_IO_L3_in_serialize1260_write { O 1 bit } } \
} "
}
