...
entity kernel0_C_drain_IO_L1_out_wrapper401 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_C_drain_IO_L1_out_wrapper401 is 
...
begin
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, grp_C_drain_IO_L1_out_fu_26_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    internal_ap_ready_assign_proc : process(grp_C_drain_IO_L1_out_fu_26_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_C_drain_IO_L1_out_fu_26_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
