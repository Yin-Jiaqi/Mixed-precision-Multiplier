...
module kernel0_C_drain_IO_L1_out_boundary_wrapper418_Pipeline_VIT_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1069_13_fu_822_p2;
reg   [0:0] icmp_ln1069_13_reg_1338;
...
reg   [15:0] ap_phi_mux_v2_V_387_phi_fu_222_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_387_reg_219;
reg   [15:0] ap_phi_mux_v2_V_386_phi_fu_260_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_386_reg_257;
reg   [15:0] ap_phi_mux_v2_V_385_phi_fu_298_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_385_reg_295;
reg   [15:0] ap_phi_mux_v2_V_384_phi_fu_336_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_384_reg_333;
reg   [15:0] ap_phi_mux_v2_V_383_phi_fu_374_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_383_reg_371;
reg   [15:0] ap_phi_mux_v2_V_382_phi_fu_412_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_382_reg_409;
reg   [15:0] ap_phi_mux_v2_V_381_phi_fu_450_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_381_reg_447;
reg   [15:0] ap_phi_mux_v2_V_380_phi_fu_488_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_380_reg_485;
reg   [15:0] ap_phi_mux_v2_V_379_phi_fu_526_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_379_reg_523;
reg   [15:0] ap_phi_mux_v2_V_378_phi_fu_564_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_378_reg_561;
reg   [15:0] ap_phi_mux_v2_V_377_phi_fu_602_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_377_reg_599;
reg   [15:0] ap_phi_mux_v2_V_376_phi_fu_640_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_376_reg_637;
reg   [15:0] ap_phi_mux_v2_V_375_phi_fu_678_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_375_reg_675;
reg   [15:0] ap_phi_mux_v2_V_374_phi_fu_716_p32;
wire   [15:0] ap_phi_reg_pp0_iter1_v2_V_374_reg_713;
...
wire   [4:0] add_ln870_12_fu_841_p2;
reg   [4:0] c6_V_fu_150;
wire   [4:0] select_ln891_9_fu_866_p3;
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd1))) begin
        ...
        ap_phi_mux_v2_V_374_phi_fu_716_p32 = {{local_C_V_q0[31:16]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd2))) begin
        ...
        ap_phi_mux_v2_V_375_phi_fu_678_p32 = {{local_C_V_q0[47:32]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd3))) begin
        ...
        ap_phi_mux_v2_V_376_phi_fu_640_p32 = {{local_C_V_q0[63:48]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd4))) begin
        ...
        ap_phi_mux_v2_V_377_phi_fu_602_p32 = {{local_C_V_q0[79:64]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd5))) begin
        ...
        ap_phi_mux_v2_V_378_phi_fu_564_p32 = {{local_C_V_q0[95:80]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd6))) begin
        ...
        ap_phi_mux_v2_V_379_phi_fu_526_p32 = {{local_C_V_q0[111:96]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd7))) begin
        ...
        ap_phi_mux_v2_V_380_phi_fu_488_p32 = {{local_C_V_q0[127:112]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd8))) begin
        ...
        ap_phi_mux_v2_V_381_phi_fu_450_p32 = {{local_C_V_q0[143:128]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd9))) begin
        ...
        ap_phi_mux_v2_V_382_phi_fu_412_p32 = {{local_C_V_q0[159:144]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd10))) begin
        ...
        ap_phi_mux_v2_V_383_phi_fu_374_p32 = {{local_C_V_q0[175:160]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd11))) begin
        ...
        ap_phi_mux_v2_V_384_phi_fu_336_p32 = {{local_C_V_q0[191:176]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd12))) begin
        ...
        ap_phi_mux_v2_V_385_phi_fu_298_p32 = {{local_C_V_q0[207:192]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd13))) begin
        ...
        ap_phi_mux_v2_V_386_phi_fu_260_p32 = {{local_C_V_q0[223:208]}};
    end else begin
...
always @ (*) begin
    if (((icmp_ln1069_reg_1334 == 1'd0) & (trunc_ln891_fu_873_p1 == 4'd14))) begin
        ...
        ap_phi_mux_v2_V_387_phi_fu_222_p32 = {{local_C_V_q0[239:224]}};
    end else begin
...
assign add_ln870_12_fu_841_p2 = (select_ln891_fu_828_p3 + 5'd1);
...
assign ap_phi_reg_pp0_iter1_v2_V_374_reg_713 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_375_reg_675 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_376_reg_637 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_377_reg_599 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_378_reg_561 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_379_reg_523 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_380_reg_485 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_381_reg_447 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_382_reg_409 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_383_reg_371 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_384_reg_333 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_385_reg_295 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_386_reg_257 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_387_reg_219 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_reg_751 = 'bx;

assign data_split_V_0_fu_877_p1 = local_C_V_q0[15:0];

assign icmp_ln1069_13_fu_822_p2 = ((ap_sig_allocacmp_c7_V_load == 5'd16) ? 1'b1 : 1'b0);
