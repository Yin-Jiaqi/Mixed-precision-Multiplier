  ...
  for (ap_uint<2> c1 = 0; c1 <= 1; c1 += 1) {
    ...
    for (ap_uint<6> c5 = 0; c5 <= 31; c5 += 1) {
      ...
      for (ap_uint<5> c6 = 0; c6 <= 15; c6 += 1) {
        // latency
        for (int c7 = 0; c7 <= min(19, -20 * p0 + 207); c7 += 1) {
        #pragma HLS PIPELINE II=1
          // simd
          {
            A_t16 in_data;
...
#pragma HLS INLINE OFF
  ...
  for (ap_uint<5> c3 = p0; c3 <= 10; c3 += 1) {
    // io_L2
    if (c3 == p0) {
      for (int c4 = 0; c4 <= min(19, -20 * p0 + 207); c4 += 1) {
        // access_coalesce
        for (ap_uint<5> c5 = 0; c5 <= 15; c5 += 1) {
        #pragma HLS PIPELINE II=1
          {
...
#pragma HLS INLINE OFF
  ...
  for (ap_uint<2> c1 = 0; c1 <= 1; c1 += 1) {
    // array
    for (ap_uint<5> c3 = p0; c3 <= 10; c3 += 10) {
      // pe
      for (ap_uint<6> c5 = 0; c5 <= 31; c5 += 1) {
        // latency
        for (ap_uint<5> c6 = 0; c6 <= 15; c6 += 1) {
          // latency
          for (int c7 = 0; c7 <= min(19, -20 * c3 + 207); c7 += 1) {
          #pragma HLS PIPELINE II=1
            {
              {
                A_t8 fifo_data;
...
#pragma HLS INLINE
  ...
  for (ap_uint<5> c6 = 0; c6 <= 15; c6 += 1) {
    // latency
    for (int c7 = 0; c7 <= min(19, -20 * p1 + 207); c7 += 1) {
    #pragma HLS PIPELINE II=1
      // simd
      {
        C_t1 in_data;
...
#pragma HLS INLINE
  ...
  for (ap_uint<5> c4 = p1; c4 <= 10; c4 += 1) {
    // io_L1
    if (c4 == p1) {
      for (int c5 = 0; c5 <= min(19, -20 * p1 + 207); c5 += 1) {
        // access_coalesce
