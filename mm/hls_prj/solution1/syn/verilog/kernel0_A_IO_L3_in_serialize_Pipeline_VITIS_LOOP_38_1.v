...
reg   [10:0] i_V_fu_46;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_V_5;
wire   [10:0] i_V_6_fu_86_p2;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_115 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_115 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_115 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0);
end
...
assign fifo_A_A_IO_L3_in_serialize69_din = fifo_data_reg_119;

assign i_V_6_fu_86_p2 = (ap_sig_allocacmp_i_V_5 + 11'd1);

assign icmp_ln38_fu_80_p2 = ((ap_sig_allocacmp_i_V_5 == 11'd1024) ? 1'b1 : 1'b0);
