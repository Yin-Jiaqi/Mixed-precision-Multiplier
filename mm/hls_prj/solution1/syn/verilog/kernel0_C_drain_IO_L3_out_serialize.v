...
wire  signed [63:0] sext_ln1164_fu_73_p1;
reg    ap_block_state1;
reg   [7:0] ap_NS_fsm;
...
always @ (*) begin
    if ((~((m_axi_gmem_C_AWREADY == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        m_axi_gmem_C_AWADDR = sext_ln1164_fu_73_p1;
...
assign sext_ln1164_fu_73_p1 = trunc_ln_fu_63_p4;
