...
reg   [31:0] ap_phi_mux_v2_V_7_phi_fu_132_p8;
wire   [31:0] ap_phi_reg_pp0_iter1_v2_V_7_reg_129;
reg   [31:0] ap_phi_mux_v2_V_6_phi_fu_146_p8;
wire   [31:0] ap_phi_reg_pp0_iter1_v2_V_6_reg_143;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1069_fu_189_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            c6_V_fu_84 <= select_ln1069_8_fu_227_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1069_fu_189_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            c7_V_fu_80 <= add_ln870_4_fu_260_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            c7_V_fu_80 <= 4'd0;
        end
    end
...
always @ (*) begin
    if (((trunc_ln1069_reg_365 == 2'd1) & (icmp_ln1069_reg_361 == 1'd0))) begin
        ap_phi_mux_v2_V_6_phi_fu_146_p8 = fifo_C_drain_PE_1_089_dout;
        ...
        ap_phi_mux_v2_V_6_phi_fu_146_p8 = {{local_C_V_q0[63:32]}};
    end else begin
        ap_phi_mux_v2_V_6_phi_fu_146_p8 = ap_phi_reg_pp0_iter1_v2_V_6_reg_143;
    end
end

always @ (*) begin
    if (((trunc_ln1069_reg_365 == 2'd2) & (icmp_ln1069_reg_361 == 1'd0))) begin
        ap_phi_mux_v2_V_7_phi_fu_132_p8 = fifo_C_drain_PE_1_089_dout;
        ...
        ap_phi_mux_v2_V_7_phi_fu_132_p8 = {{local_C_V_q0[95:64]}};
    end else begin
        ap_phi_mux_v2_V_7_phi_fu_132_p8 = ap_phi_reg_pp0_iter1_v2_V_7_reg_129;
    end
end
...
assign add_ln870_4_fu_260_p2 = (select_ln1069_fu_219_p3 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln1069_reg_361 == 1'd0) & (fifo_C_drain_PE_1_089_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln1069_reg_361 == 1'd0) & (fifo_C_drain_PE_1_089_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln1069_reg_361 == 1'd0) & (fifo_C_drain_PE_1_089_empty_n == 1'b0));
end
...
assign ap_phi_reg_pp0_iter1_v2_V_6_reg_143 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_7_reg_129 = 'bx;

assign ap_phi_reg_pp0_iter1_v2_V_reg_157 = 'bx;

assign data_split_V_0_fu_281_p1 = local_C_V_q0[31:0];

assign icmp_ln1069_8_fu_213_p2 = ((ap_sig_allocacmp_c7_V_load == 4'd8) ? 1'b1 : 1'b0);
...
assign local_C_V_d1 = {{{{ap_phi_mux_v1_V_phi_fu_118_p8}, {ap_phi_mux_v2_V_7_phi_fu_132_p8}}, {ap_phi_mux_v2_V_6_phi_fu_146_p8}}, {ap_phi_mux_v2_V_phi_fu_160_p8}};

assign select_ln1069_8_fu_227_p3 = ((icmp_ln1069_8_fu_213_p2[0:0] == 1'b1) ? add_ln870_fu_207_p2 : ap_sig_allocacmp_c6_V_load);

assign select_ln1069_fu_219_p3 = ((icmp_ln1069_8_fu_213_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_c7_V_load);

assign tmp_2_fu_235_p3 = select_ln1069_8_fu_227_p3[32'd2];

assign tmp_fu_247_p3 = {{select_ln1069_fu_219_p3}, {tmp_2_fu_235_p3}};

assign trunc_ln1069_fu_243_p1 = select_ln1069_8_fu_227_p3[1:0];

assign zext_ln859_fu_255_p1 = tmp_fu_247_p3;
