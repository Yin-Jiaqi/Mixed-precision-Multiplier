...
attribute shreg_extract : string;
    ...
    signal sext_ln1164_fu_73_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    m_axi_gmem_C_AWADDR_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, m_axi_gmem_C_AWREADY, grp_C_drain_IO_L3_out_serialize_Pipeline_VITIS_LOOP_11_fu_54_m_axi_gmem_C_AWADDR, ap_CS_fsm_state2, ap_CS_fsm_state3, sext_ln1164_fu_73_p1)
    begin
        if ((not(((m_axi_gmem_C_AWREADY = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        ...
        sext_ln1164_fu_73_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_63_p4),64));
