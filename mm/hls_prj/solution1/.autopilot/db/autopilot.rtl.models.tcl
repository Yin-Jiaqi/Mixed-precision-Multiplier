set SynModuleInfo {
  ...
  {SRCNAME A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1 MODELNAME A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1 RTLNAME kernel0_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_38_1
    SUBMODULES {
  ...
  {SRCNAME A_IO_L2_in_intra_trans_Pipeline_VITIS_LOOP_62_1_VI MODELNAME A_IO_L2_in_intra_trans_Pipeline_VITIS_LOOP_62_1_VI RTLNAME kernel0_A_IO_L2_in_intra_trans_Pipeline_VITIS_LOOP_62_1_VI
    SUBMODULES {
      {MODELNAME kernel0_mux_83_64_1_1 RTLNAME kernel0_mux_83_64_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_383_1 MODELNAME B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_383_1 RTLNAME kernel0_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_383_1}
  ...
  {SRCNAME kernel0 MODELNAME kernel0 RTLNAME kernel0 IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME kernel0_fifo_w512_d2_S RTLNAME kernel0_fifo_w512_d2_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME kernel0_fifo_w64_d2_S RTLNAME kernel0_fifo_w64_d2_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
