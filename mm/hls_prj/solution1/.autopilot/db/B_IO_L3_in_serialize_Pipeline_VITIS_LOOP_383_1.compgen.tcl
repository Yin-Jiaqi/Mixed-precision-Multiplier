...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln383 \
    op interface \
    ports { sext_ln383 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_B_B_IO_L3_in_serialize70_din { O 512 vector } fifo_B_B_IO_L3_in_serialize70_full_n { I 1 bit } fifo_B_B_IO_L3_in_serialize70_write { O 1 bit } } \
} "
}
