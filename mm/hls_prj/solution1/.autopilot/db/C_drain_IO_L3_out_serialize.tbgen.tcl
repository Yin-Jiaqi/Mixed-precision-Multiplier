set moduleName C_drain_IO_L3_out_serialize
set isTopModule 0
...
set C_modelName {C_drain_IO_L3_out_serialize}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_C int 512 regular {axi_master 1}  }
	{ p_read int 64 regular  }
	{ fifo_C_drain_C_drain_IO_L3_out_serialize71 int 128 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_C", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "C","offset": { "type": "dynamic","port_name": "C","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_C_drain_C_drain_IO_L3_out_serialize71", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ fifo_C_drain_C_drain_IO_L3_out_serialize71_dout sc_in sc_lv 128 signal 2 } 
	{ fifo_C_drain_C_drain_IO_L3_out_serialize71_empty_n sc_in sc_logic 1 signal 2 } 
	{ fifo_C_drain_C_drain_IO_L3_out_serialize71_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_C_drain_C_drain_IO_L3_out_serialize71_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "fifo_C_drain_C_drain_IO_L3_out_serialize71", "role": "dout" }} , 
 	{ "name": "fifo_C_drain_C_drain_IO_L3_out_serialize71_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_C_drain_C_drain_IO_L3_out_serialize71", "role": "empty_n" }} , 
 	{ "name": "fifo_C_drain_C_drain_IO_L3_out_serialize71_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_C_drain_C_drain_IO_L3_out_serialize71", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem_C", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_C_drain_IO_L3_out_serialize_Pipeline_VITIS_LOOP_11_fu_54", "Port" : "gmem_C", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "12", "DependentChanType" : "1"},
			{"Name" : "fifo_C_drain_C_drain_IO_L3_out_serialize71", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_C_drain_IO_L3_out_serialize_Pipeline_VITIS_LOOP_11_fu_54", "Port" : "fifo_C_drain_C_drain_IO_L3_out_serialize71", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_C_drain_IO_L3_out_serialize_Pipeline_VITIS_LOOP_11_fu_54", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_C_drain_IO_L3_out_serialize_Pipeline_VITIS_LOOP_11_fu_54.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1037", "Max" : "1037"}
]}
...
set Spec2ImplPortList { 
	...
	fifo_C_drain_C_drain_IO_L3_out_serialize71 { ap_fifo {  { fifo_C_drain_C_drain_IO_L3_out_serialize71_dout fifo_data 0 128 }  { fifo_C_drain_C_drain_IO_L3_out_serialize71_empty_n fifo_status 0 1 }  { fifo_C_drain_C_drain_IO_L3_out_serialize71_read fifo_update 1 1 } } }
}
