...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1164 \
    op interface \
    ports { sext_ln1164 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_C_drain_C_drain_IO_L3_out_serialize71_dout { I 128 vector } fifo_C_drain_C_drain_IO_L3_out_serialize71_empty_n { I 1 bit } fifo_C_drain_C_drain_IO_L3_out_serialize71_read { O 1 bit } } \
} "
}
