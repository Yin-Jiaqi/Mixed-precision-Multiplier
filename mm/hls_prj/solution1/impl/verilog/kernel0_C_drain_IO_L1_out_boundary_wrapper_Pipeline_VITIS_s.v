...
module kernel0_C_drain_IO_L1_out_boundary_wrapper_Pipeline_VITIS_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln934_1_fu_169_p1;
reg   [1:0] c6_V_fu_56;
wire    ap_loop_init;
...
assign icmp_ln1069_9_fu_131_p2 = ((ap_sig_allocacmp_c6_V_load == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln1069_fu_107_p2 = ((ap_sig_allocacmp_indvar_flatten7_load == 5'd16) ? 1'b1 : 1'b0);

assign local_C_V_address0 = zext_ln934_1_fu_169_p1;

assign select_ln1069_9_fu_145_p3 = ((icmp_ln1069_9_fu_131_p2[0:0] == 1'b1) ? add_ln870_fu_125_p2 : ap_sig_allocacmp_c5_V_load);

assign select_ln1069_fu_137_p3 = ((icmp_ln1069_9_fu_131_p2[0:0] == 1'b1) ? 2'd0 : ap_sig_allocacmp_c6_V_load);

assign shl_ln1069_fu_153_p2 = select_ln1069_9_fu_145_p3 << 4'd1;

assign zext_ln934_1_fu_169_p1 = add_ln934_fu_163_p2;

assign zext_ln934_fu_159_p1 = select_ln1069_fu_137_p3;

endmodule //kernel0_C_drain_IO_L1_out_boundary_wrapper_Pipeline_VITIS_s
