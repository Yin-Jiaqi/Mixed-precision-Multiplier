...
output   start_out;
output   start_write;
input  [511:0] fifo_A_A_IO_L2_in_173_dout;
...
wire   [2:0] add_ln870_16_fu_181_p2;
reg   [2:0] add_ln870_16_reg_227;
wire    ap_CS_fsm_state3;
wire   [2:0] add_ln870_17_fu_197_p2;
reg   [2:0] add_ln870_17_reg_235;
...
reg   [511:0] grp_A_IO_L2_in_intra_trans_fu_138_local_A_q0;
wire   [63:0] grp_A_IO_L2_in_intra_trans_fu_138_fifo_A_PE_1_079_din;
...
wire   [511:0] grp_A_IO_L2_in_inter_trans_boundary_fu_148_local_A_d1;
reg   [0:0] intra_trans_en_reg_64;
wire   [0:0] icmp_ln1069_22_fu_175_p2;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_78;
wire   [0:0] icmp_ln1069_23_fu_191_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_3_phi_fu_130_p4 == 1'd1) & (icmp_ln1069_23_fu_191_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_3_phi_fu_130_p4 == 1'd0) & (icmp_ln1069_23_fu_191_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_3_phi_fu_130_p4 == 1'd1) & (icmp_ln1069_23_fu_191_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state4) & (ap_phi_mux_arb_3_phi_fu_130_p4 == 1'd0) & (icmp_ln1069_23_fu_191_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln1069_fu_163_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_22_fu_175_p2 == 1'd0))) begin
        arb_3_reg_126 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_fu_52 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_22_fu_175_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1069_fu_163_p2 == 1'd0))) begin
        c1_V_reg_78 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln1069_23_fu_191_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln1069_22_fu_175_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln1069_23_fu_191_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
...
assign add_ln870_16_fu_181_p2 = (c1_V_reg_78 + 3'd1);

assign add_ln870_17_fu_197_p2 = (c2_V_reg_102 + 3'd1);
...
assign icmp_ln1069_22_fu_175_p2 = ((c1_V_reg_78 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln1069_23_fu_191_p2 = ((c2_V_reg_102 == 3'd4) ? 1'b1 : 1'b0);
