...
module kernel0_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_383_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln383_reg_115;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln383_fu_80_p2;
...
reg   [10:0] i_V_fu_46;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_V_3;
wire   [10:0] i_V_4_fu_86_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln383_fu_80_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln383_reg_115 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        fifo_data_reg_119 <= m_axi_gmem_B_RDATA;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln383_fu_80_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln383_reg_115 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln383_reg_115 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln383_reg_115 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln383_reg_115 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln383_reg_115 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln383_reg_115 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln383_reg_115 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0);
end
...
assign fifo_B_B_IO_L3_in_serialize70_din = fifo_data_reg_119;

assign i_V_4_fu_86_p2 = (ap_sig_allocacmp_i_V_3 + 11'd1);

assign icmp_ln383_fu_80_p2 = ((ap_sig_allocacmp_i_V_3 == 11'd1024) ? 1'b1 : 1'b0);
...
endmodule //kernel0_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_383_1
