...
/* Module Definition */
void A_IO_L3_in_serialize(A_t32 *A, hls::stream<A_t16> &fifo_A_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void B_IO_L3_in_serialize(B_t32 *B, hls::stream<B_t16> &fifo_B_local_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void PE(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<unsigned short> &fifo_C_drain_out) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
              ...
              {
                {
                  ...
                  #pragma HLS UNROLL
                    union {unsigned int ui; unsigned short ut;} u;
                    u.ui = (unsigned int)fifo_data(15, 0);
                    local_A[0][n] = u.ut;
                    fifo_data = fifo_data >> 16;
                  }
                }
                {
                  B_t2 fifo_data;
                ...
                {
                  B_t2 fifo_data;
                  union {unsigned int ui; unsigned short ut;} u1, u0;
                  u1.ut = local_B[0][1];
                  u0.ut = local_B[0][0];
                  fifo_data = (ap_uint<16>(u1.ui), ap_uint<16>(u0.ui));
...
/* Module Definition */
void PE_wrapper(int idx, int idy, hls::stream<A_t2> &fifo_A_in, hls::stream<A_t2> &fifo_A_out, hls::stream<B_t2> &fifo_B_in, hls::stream<B_t2> &fifo_B_out, hls::stream<unsigned short> &fifo_C_drain_out)
 {
  PE(
    /* module id */ idx, 
    /* module id */ idy, 
...
/* Module Definition */
void C_drain_IO_L1_out_intra_trans(int idx, int idy, int c0, int c1, C_t8 local_C[8][1], hls::stream<unsigned short> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  ap_uint<16> data_split[8];
  #pragma HLS ARRAY_PARTITION variable=data_split complete
  /* Variable Declaration */
  ...
  for (ap_uint<4> c6 = 0; c6 <= 7; c6 += 1) {
    ...
    #pragma HLS PIPELINE II=1
      // simd
      {
        ...
        for (ap_uint<4> n = 0; n < 8; n++) {
        #pragma HLS UNROLL
          data_split[n] = out_data(15, 0);
          out_data = out_data >> 16;
        }
        union {unsigned int ui; unsigned short ut;} u;
        u.ut = in_data;
        data_split[split_idx] = ap_uint<16>(u.ui);
        out_data = (data_split[7], data_split[6], data_split[5], data_split[4], data_split[3], data_split[2], data_split[1], data_split[0]);        local_C[c7][c6 / 8] = out_data;
      }
    }
  }
}
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans(int idx, int idy, int c0, int c1, C_t8 local_C[8][1], hls::stream<C_t8> &fifo_C_drain_in, hls::stream<C_t8> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out_inter_trans_boundary(int idx, int idy, int c0, int c1, C_t8 local_C[8][1], hls::stream<C_t8> &fifo_C_drain_out) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L1_out(int idx, int idy, hls::stream<C_t8> &fifo_C_drain_in, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<unsigned short> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t8 local_C[8][1];
...
/* Module Definition */
void C_drain_IO_L1_out_wrapper(int idx, int idy, hls::stream<C_t8> &fifo_C_drain_in, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<unsigned short> &fifo_C_drain_local_in)
 {
  C_drain_IO_L1_out(
    /* module id */ idx, 
    /* module id */ idy, 
...
/* Module Definition */
void C_drain_IO_L1_out_boundary(int idx, int idy, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<unsigned short> &fifo_C_drain_local_in) {
#pragma HLS INLINE
  /* Variable Declaration */
  int p0 = idx, p1 = idy; // module id
  C_t8 local_C[8][1];
...
/* Module Definition */
void C_drain_IO_L1_out_boundary_wrapper(int idx, int idy, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<unsigned short> &fifo_C_drain_local_in)
 {
...
/* Module Definition */
void C_drain_IO_L2_out(int idx, hls::stream<C_t8> &fifo_C_drain_in, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<C_t8> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L2_out_boundary(int idx, hls::stream<C_t8> &fifo_C_drain_out, hls::stream<C_t8> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  int p0 = idx; // module id
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out(hls::stream<C_t8> &fifo_C_drain_out, hls::stream<C_t8> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
void C_drain_IO_L3_out_serialize(C_t32 *C, hls::stream<C_t8> &fifo_C_drain_local_in) {
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */

  for (ap_uint<8> i = 0; i < 128; i++) {
  #pragma HLS PIPELINE II=1
    C_t8 fifo_data;
    C_t32 mem_data;
...
void kernel0(A_t32 *A, B_t32 *B, C_t32 *C)
{
...
#pragma HLS DATAFLOW
  ...
  /* C_drain_IO_L3_out_serialize fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L3_out_serialize;
  ...
  /* C_drain_IO_L1_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L1_out_0_1;
  ...
  /* C_drain_IO_L1_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L1_out_0_2;
  ...
  /* C_drain_IO_L1_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L1_out_1_0;
  ...
  /* C_drain_IO_L1_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L1_out_1_1;
  ...
  /* C_drain_IO_L1_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L1_out_1_2;
  ...
  /* C_drain_IO_L2_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L2_out_0;
  ...
  /* C_drain_IO_L2_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L2_out_1;
  ...
  /* C_drain_IO_L2_out fifo */ hls::stream<C_t8> fifo_C_drain_C_drain_IO_L2_out_2;
