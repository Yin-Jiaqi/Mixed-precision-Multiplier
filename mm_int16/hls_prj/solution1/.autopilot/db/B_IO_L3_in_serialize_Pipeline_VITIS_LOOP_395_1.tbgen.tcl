set moduleName B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1
set isTopModule 0
...
set C_modelName {B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_B int 512 regular {axi_master 0}  }
	{ sext_ln395 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_B", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln395", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln395 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln395", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln395", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln395 { ap_none {  { sext_ln395 in_data 0 58 } } }
