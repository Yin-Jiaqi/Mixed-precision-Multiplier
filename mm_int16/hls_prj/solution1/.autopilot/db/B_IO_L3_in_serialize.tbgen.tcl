...
set C_modelArgList {
	...
	{ B int 64 regular  }
	{ fifo_B_B_IO_L3_in_serialize70 int 256 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_B", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_B_B_IO_L3_in_serialize70", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fifo_B_B_IO_L3_in_serialize70_din sc_out sc_lv 256 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_B_B_IO_L3_in_serialize70_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "fifo_B_B_IO_L3_in_serialize70", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem_B", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1_fu_51", "Port" : "gmem_B", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			...
			{"Name" : "fifo_B_B_IO_L3_in_serialize70", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1_fu_51", "Port" : "fifo_B_B_IO_L3_in_serialize70", "Inst_start_state" : "8", "Inst_end_state" : "9"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1_fu_51", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1_fu_51.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	fifo_B_B_IO_L3_in_serialize70 { ap_fifo {  { fifo_B_B_IO_L3_in_serialize70_din fifo_data 1 256 }  { fifo_B_B_IO_L3_in_serialize70_full_n fifo_status 0 1 }  { fifo_B_B_IO_L3_in_serialize70_write fifo_update 1 1 } } }
}
set moduleName B_IO_L3_in_serialize
set isTopModule 0
set isCombinational 0
