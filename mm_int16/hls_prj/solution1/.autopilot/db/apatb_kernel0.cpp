...
#define AUTOTB_TVOUT_gmem_A "../tv/cdatafile/c.kernel0.autotvout_gmem_A.dat"
// wrapc file define:
#define AUTOTB_TVIN_gmem_B "../tv/cdatafile/c.kernel0.autotvin_gmem_B.dat"
#define AUTOTB_TVOUT_gmem_B "../tv/cdatafile/c.kernel0.autotvout_gmem_B.dat"
// wrapc file define:
...
// wrapc file define:
#define AUTOTB_TVIN_A "../tv/cdatafile/c.kernel0.autotvin_A.dat"
#define AUTOTB_TVOUT_A "../tv/cdatafile/c.kernel0.autotvout_A.dat"
// wrapc file define:
#define AUTOTB_TVIN_B "../tv/cdatafile/c.kernel0.autotvin_B.dat"
#define AUTOTB_TVOUT_B "../tv/cdatafile/c.kernel0.autotvout_B.dat"
// wrapc file define:
#define AUTOTB_TVIN_C "../tv/cdatafile/c.kernel0.autotvin_C.dat"
#define AUTOTB_TVOUT_C "../tv/cdatafile/c.kernel0.autotvout_C.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_gmem_A "../tv/rtldatafile/rtl.kernel0.autotvout_gmem_A.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem_B "../tv/rtldatafile/rtl.kernel0.autotvout_gmem_B.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem_C "../tv/rtldatafile/rtl.kernel0.autotvout_gmem_C.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_A "../tv/rtldatafile/rtl.kernel0.autotvout_A.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_B "../tv/rtldatafile/rtl.kernel0.autotvout_B.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_C "../tv/rtldatafile/rtl.kernel0.autotvout_C.dat"
...
extern "C" void kernel0_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);

extern "C" void apatb_kernel0_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<512> > gmem_C_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_C)[j*8+0] = gmem_C_pc_buffer[i].range(63,0).to_int64();
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_A)[j*8+7];
    ...
    aesl_fh.write(AUTOTB_TVIN_gmem_A, s.append("\n")); 
      }
  }
}
  tcl_file.set_num(1, &tcl_file.gmem_A_depth);
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_B)[j*8+7];
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_gmem_B, s.append("\n")); 
      }
  }
}
  tcl_file.set_num(1, &tcl_file.gmem_B_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_gmem_B, __xlx_sprintf_buffer.data());
}
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_C)[j*8+7];
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_gmem_C, s.append("\n")); 
      }
  }
}
  tcl_file.set_num(1, &tcl_file.gmem_C_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_gmem_C, __xlx_sprintf_buffer.data());
}
...
kernel0_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_C);
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_C)[j*8+7];
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVOUT_gmem_C, s.append("\n")); 
      }
  }
}
  tcl_file.set_num(1, &tcl_file.gmem_C_depth);
