...
set C_modelArgList {
	...
	{ A int 64 regular  }
	{ fifo_A_A_IO_L3_in_serialize69 int 256 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_A", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_A_A_IO_L3_in_serialize69", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fifo_A_A_IO_L3_in_serialize69_din sc_out sc_lv 256 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_A_A_IO_L3_in_serialize69_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize69", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem_A", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1_fu_51", "Port" : "gmem_A", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			...
			{"Name" : "fifo_A_A_IO_L3_in_serialize69", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1_fu_51", "Port" : "fifo_A_A_IO_L3_in_serialize69", "Inst_start_state" : "8", "Inst_end_state" : "9"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1_fu_51", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1_fu_51.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	fifo_A_A_IO_L3_in_serialize69 { ap_fifo {  { fifo_A_A_IO_L3_in_serialize69_din fifo_data 1 256 }  { fifo_A_A_IO_L3_in_serialize69_full_n fifo_status 0 1 }  { fifo_A_A_IO_L3_in_serialize69_write fifo_update 1 1 } } }
}
set moduleName A_IO_L3_in_serialize
set isTopModule 0
set isCombinational 0
