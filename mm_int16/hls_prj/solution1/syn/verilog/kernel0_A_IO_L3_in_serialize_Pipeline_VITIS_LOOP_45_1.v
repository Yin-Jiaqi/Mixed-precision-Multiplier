...
module kernel0_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg[255:0] fifo_A_A_IO_L3_in_serialize69_din;
...
reg    fifo_A_A_IO_L3_in_serialize69_blk_n;
...
reg   [9:0] i_V_fu_52;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i_V_5;
wire   [9:0] i_V_6_fu_92_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln45_fu_86_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln45_reg_135 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        p_Result_1_reg_144 <= {{m_axi_gmem_A_RDATA[511:256]}};
        trunc_ln674_reg_139 <= trunc_ln674_fu_109_p1;
    end
end

always @ (*) begin
    if (((icmp_ln45_reg_135 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
        ...
        fifo_A_A_IO_L3_in_serialize69_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_01001))) begin
            ...
            fifo_A_A_IO_L3_in_serialize69_din = 'bx;
        end
    end else begin
        fifo_A_A_IO_L3_in_serialize69_din = 'bx;
    end
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        fifo_A_A_IO_L3_in_serialize69_write = 1'b1;
    end else begin
...
always @ (*) begin
    if (((icmp_ln45_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln45_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln45_reg_135 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln45_reg_135 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln45_reg_135 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((icmp_ln45_reg_135 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0);
end

always @ (*) begin
    ap_block_state4_pp0_stage1_iter1 = (fifo_A_A_IO_L3_in_serialize69_full_n == 1'b0);
end
...
assign i_V_6_fu_92_p2 = (ap_sig_allocacmp_i_V_5 + 10'd1);

assign icmp_ln45_fu_86_p2 = ((ap_sig_allocacmp_i_V_5 == 10'd512) ? 1'b1 : 1'b0);
...
assign trunc_ln674_fu_109_p1 = m_axi_gmem_A_RDATA[255:0];

endmodule //kernel0_A_IO_L3_in_serialize_Pipeline_VITIS_LOOP_45_1
