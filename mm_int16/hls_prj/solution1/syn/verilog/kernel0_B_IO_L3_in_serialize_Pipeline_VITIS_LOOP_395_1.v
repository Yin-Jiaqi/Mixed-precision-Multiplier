...
module kernel0_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [57:0] sext_ln395;

reg ap_idle;
reg m_axi_gmem_B_RREADY;
reg[255:0] fifo_B_B_IO_L3_in_serialize70_din;
...
reg    fifo_B_B_IO_L3_in_serialize70_blk_n;
wire    ap_block_pp0_stage0;
wire    ap_block_state1_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln395_fu_86_p2;
wire   [255:0] trunc_ln674_fu_109_p1;
reg   [255:0] trunc_ln674_reg_139;
reg    ap_block_pp0_stage1_11001;
reg   [255:0] p_Result_1_reg_144;
reg    ap_enable_reg_pp0_iter0_reg;
reg   [9:0] i_V_fu_52;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i_V_3;
wire   [9:0] i_V_4_fu_92_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln395_fu_86_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln395_reg_135 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        p_Result_1_reg_144 <= {{m_axi_gmem_B_RDATA[511:256]}};
        trunc_ln674_reg_139 <= trunc_ln674_fu_109_p1;
    end
end

always @ (*) begin
    if (((icmp_ln395_reg_135 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
        ...
        fifo_B_B_IO_L3_in_serialize70_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_01001))) begin
            ...
            fifo_B_B_IO_L3_in_serialize70_din = 'bx;
        end
    end else begin
        fifo_B_B_IO_L3_in_serialize70_din = 'bx;
    end
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        fifo_B_B_IO_L3_in_serialize70_write = 1'b1;
    end else begin
...
always @ (*) begin
    if (((icmp_ln395_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln395_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln395_reg_135 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln395_reg_135 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln395_reg_135 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((icmp_ln395_reg_135 == 1'd0) & (m_axi_gmem_B_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0);
end

always @ (*) begin
    ap_block_state4_pp0_stage1_iter1 = (fifo_B_B_IO_L3_in_serialize70_full_n == 1'b0);
end
...
assign i_V_4_fu_92_p2 = (ap_sig_allocacmp_i_V_3 + 10'd1);

assign icmp_ln395_fu_86_p2 = ((ap_sig_allocacmp_i_V_3 == 10'd512) ? 1'b1 : 1'b0);
...
assign trunc_ln674_fu_109_p1 = m_axi_gmem_B_RDATA[255:0];

endmodule //kernel0_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_395_1
