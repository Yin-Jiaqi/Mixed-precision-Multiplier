...
architecture behav of kernel0_PE_wrapper8 is 
...
attribute shreg_extract : string;
    ...
    signal grp_PE_fu_28_fifo_A_PE_0_076_read : STD_LOGIC;
    signal grp_PE_fu_28_fifo_B_PE_0_082_read : STD_LOGIC;
    signal grp_PE_fu_28_fifo_B_PE_1_083_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_PE_fu_28_fifo_B_PE_1_083_write : STD_LOGIC;
    signal grp_PE_fu_28_fifo_A_PE_0_177_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_PE_fu_28_fifo_A_PE_0_177_write : STD_LOGIC;
    signal grp_PE_fu_28_fifo_C_drain_PE_0_088_din : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_PE_fu_28_fifo_C_drain_PE_0_088_write : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        fifo_A_PE_0_076_dout => fifo_A_PE_0_076_dout,
        fifo_A_PE_0_076_empty_n => fifo_A_PE_0_076_empty_n,
        fifo_A_PE_0_076_read => grp_PE_fu_28_fifo_A_PE_0_076_read,
        fifo_B_PE_0_082_dout => fifo_B_PE_0_082_dout,
        fifo_B_PE_0_082_empty_n => fifo_B_PE_0_082_empty_n,
        fifo_B_PE_0_082_read => grp_PE_fu_28_fifo_B_PE_0_082_read,
        fifo_B_PE_1_083_din => grp_PE_fu_28_fifo_B_PE_1_083_din,
        fifo_B_PE_1_083_full_n => fifo_B_PE_1_083_full_n,
        fifo_B_PE_1_083_write => grp_PE_fu_28_fifo_B_PE_1_083_write,
        fifo_A_PE_0_177_din => grp_PE_fu_28_fifo_A_PE_0_177_din,
        fifo_A_PE_0_177_full_n => fifo_A_PE_0_177_full_n,
        fifo_A_PE_0_177_write => grp_PE_fu_28_fifo_A_PE_0_177_write,
        fifo_C_drain_PE_0_088_din => grp_PE_fu_28_fifo_C_drain_PE_0_088_din,
        fifo_C_drain_PE_0_088_full_n => fifo_C_drain_PE_0_088_full_n,
        fifo_C_drain_PE_0_088_write => grp_PE_fu_28_fifo_C_drain_PE_0_088_write);
    ...
    fifo_A_PE_0_076_read_assign_proc : process(grp_PE_fu_28_fifo_A_PE_0_076_read, ap_CS_fsm_state2)
    begin
    ...
    fifo_A_PE_0_177_write_assign_proc : process(grp_PE_fu_28_fifo_A_PE_0_177_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_A_PE_0_177_write <= grp_PE_fu_28_fifo_A_PE_0_177_write;
        else 
    ...
    fifo_B_PE_0_082_read_assign_proc : process(grp_PE_fu_28_fifo_B_PE_0_082_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_B_PE_0_082_read <= grp_PE_fu_28_fifo_B_PE_0_082_read;
        else 
    ...
    fifo_B_PE_1_083_write_assign_proc : process(grp_PE_fu_28_fifo_B_PE_1_083_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_B_PE_1_083_write <= grp_PE_fu_28_fifo_B_PE_1_083_write;
        else 
    ...
    fifo_C_drain_PE_0_088_write_assign_proc : process(grp_PE_fu_28_fifo_C_drain_PE_0_088_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_C_drain_PE_0_088_write <= grp_PE_fu_28_fifo_C_drain_PE_0_088_write;
        else 
